      ...
      <div className="hidden sm:flex items-center space-x-4 px-6">
        <Link href="/"
          className={`flex flex-col flex-1 items-center px-4 py-1
            ${pathname === "/" ? "border-b-4 rounded-b-sm border-black text-black" : "text-gray-500 opacity-60"} 
        ...
        <Link href="/network"
          className={`flex flex-col flex-1 items-center px-4 py-1 
            ${pathname === "/network" ? "border-b-4 rounded-b-sm border-black text-black" : "text-gray-500 opacity-60"} 
            transition-all duration-300 ease-in-out`}
        >
